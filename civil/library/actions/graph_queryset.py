...
#==============================================================================
def graph_queryset_action(description=_("Graph selected records")):
    ...
    def graph_queryset(modeladmin, request, queryset):
        ...
        return render_to_response('admin/actions/graph_queryset.html', RequestContext(request, ctx))

    graph_queryset.short_description = description
