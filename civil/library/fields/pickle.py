...
def dbsafe_encode(value, compress_object=False):
    ...
    if not compress_object:
        value = base64.b64encode(dumps(deepcopy(value)))
    else:
        value = base64.b64encode(compress(dumps(deepcopy(value))))
...
def dbsafe_decode(value, compress_object=False):
    ...
    if not compress_object:
        value = loads(base64.b64decode(value))
    else:
        value = loads(decompress(base64.b64decode(value)))
    return value
...
class PickledObjectField(models.Field):
    ...
    def get_db_prep_value(self, value):
        ...
        if value is not None and not isinstance(value, PickledObject):
            ...
            value = encoding.force_unicode(dbsafe_encode(value, self.compress))
        return value
