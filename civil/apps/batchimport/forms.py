...
class ImportOptionsForm(forms.Form):
	show_successful_imports = forms.BooleanField(initial=batchimport_settings.BATCH_IMPORT_SHOW_SUCCESSFUL_IMPORTS, required=False)
	show_successful_updates = forms.BooleanField(initial=batchimport_settings.BATCH_IMPORT_SHOW_SUCCESSFUL_UPDATES, required=False)
	show_errors = forms.BooleanField(initial=batchimport_settings.BATCH_IMPORT_SHOW_ERRORS, required=False)
	stop_on_first_error = forms.BooleanField(initial=batchimport_settings.BATCH_IMPORT_STOP_ON_FIRST_ERROR, required=False)
	update_dupes = forms.BooleanField(initial=batchimport_settings.BATCH_IMPORT_UPDATE_DUPS, required=False)
	start_row = forms.IntegerField(initial=batchimport_settings.BATCH_IMPORT_START_ROW, required=False)
	end_row = forms.IntegerField(initial=batchimport_settings.BATCH_IMPORT_END_ROW, required=False)
